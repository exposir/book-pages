...
| 页面                                                                            | 描述                                         |
| ------------------------------------------------------------------------------- | -------------------------------------------- |
| [章节详细版](https://exposir.github.io/book-pages/red-roulette-chapters.html)   | 多章节导航式深度解析，含人物分析、案例研究等 |
| [时间线分析版](https://exposir.github.io/book-pages/red-roulette-timeline.html) | 可视化分析版本，含关系网图、时间线、剧情等   |
